...
fixup()
{
    ...
    PTXCONF_PROJECT="OSELAS.Toolchain-2014.12.3"
	...
	*)
	...
	# hard, neon, arm
	arm-v7aarm-linux-gnueabihf)
	    PTXCONF_CROSS_GCC_CONFIG_EXTRA="--with-float=hard	--with-fpu=vfpv3-d16			--with-arch=armv7-a	--with-mode=arm		--with-tune=cortex-a9"
	    ;;
